...
export default async function DashboardLayout({
  ...
  const name = isGf
    ...
    : profile
      ...
      : (user.email ?? "");
  const rolle = isGf ? "Geschäftsführer" : "Berater";
  ...
  return (
    ...
    <div className="theme-midnight min-h-screen bg-background text-foreground">
      ...
      <div className="relative z-10">
        <MobileNav name={name} rolle={rolle} isGf={isGf} bereiche={bereiche} fotoUrl={fotoUrl} />
        <div className="lg:flex">
          <DesktopSidebar name={name} rolle={rolle} isGf={isGf} bereiche={bereiche} fotoUrl={fotoUrl} />
