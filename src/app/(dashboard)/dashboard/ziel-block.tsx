    ...
    return (
      <div className="rounded-xl border border-border bg-surface p-6">
        ...
        <p className="mt-3 text-sm text-muted-foreground">
          Noch kein Monatsziel vereinbart — lege es gemeinsam mit deiner
          Geschäftsführung fest, dann siehst du hier deinen Fortschritt.
        </p>
      </div>
    );
  }
      ...
      <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            Eigene Provision im {daten.monatsName} — vereinbart mit deiner
            Geschäftsführung.
          </p>
        </div>
        {daten.aktivTage >= 2 && (
